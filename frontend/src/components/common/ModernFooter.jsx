      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-16">
          <div className="relative mb-12">
            ...
            <h2 className="text-center text-red-500 text-sm tracking-[0.3em] font-medium relative bg-white inline-block left-1/2 -translate-x-1/2 px-6">
              GET IN TOUCH
            </h2>
          </div>
          ...
          <p className="text-gray-700 text-center max-w-2xl mx-auto leading-relaxed mb-12">
        ...
        {/* OFFICE + LINKS */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16 pb-16 border-b border-gray-300">
            ...
            <ul className="space-y-2">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.url}
                    className="text-gray-700 text-sm hover:text-red-500 transition-colors duration-300 inline-block hover:translate-x-1 transform"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          {/* <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 rounded-full border border-gray-400 focus:outline-none focus:border-amber-400 text-sm transition-all duration-300"
              />
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-gray-600 text-[9px] tracking-[0.2em] uppercase">
                  Architecture
                </span>
              </div>
            </div>
            ...
            <Link
              to="/login"
              className="text-gray-700 text-[11px] tracking-wider hover:text-red-500 transition-colors duration-300 uppercase font-medium"
            >
              Admin Access
            </Link>
            ...
            {socialLinks.map((social, index) => {
              ...
              return (
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-gray-400 flex items-center justify-center text-gray-700 hover:text-white hover:border-transparent transition-all duration-300 transform hover:scale-110"
                  style={{
                    background:
                      hoveredSocial === index
