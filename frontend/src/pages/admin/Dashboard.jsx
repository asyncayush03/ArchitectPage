...
export default function AdminDashboard() {
  ...
  // Updated Cards (Remove Team Members)
  const cards = [
    {
      id: "media",
      title: "Manage Media",
      description: "Create & edit media posts",
      icon: FileText,
      color: "from-red-500 to-red-700",
      stats: `${mediaCount} Media Posts`,
      to: "/admin/media",
    },
    {
      id: "projects",
  ...
  // Updated Stats Section (Removed Team Members + Total Views)
  const stats = [
    {
      label: "Media Posts",
      value: mediaCount,
  ...
  // Updated Quick Actions (Removed Add Member)
  const quickActions = [
    {
      label: "New Project",
      icon: FolderOpen,
    ...
    {
  label: "Logout",
  icon: LogOut,   // or use LogOut icon if you prefer
  action: "logout",
  color: "red",
}
,
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
        ...
        <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-red-600 via-red-700 to-red-800">
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
            ...
            <h1 className="text-5xl md:text-6xl font-light mb-4 text-white animate-fade-in-up">
              Admin Dashboard
            </h1>
            ...
            <div className="flex justify-center gap-4 animate-fade-in-up delay-200">
              <Link 
                to="/admin/projects"
                className="px-8 py-3 bg-white text-red-600 font-medium hover:bg-gray-100 transition-all flex items-center gap-2 hover:scale-105 hover:shadow-2xl active:scale-95"
              >
                NEW PROJECT
                <ArrowRight className="w-5 h-5" />
              </Link>
              ...
              <button 
                onClick={() => window.scrollTo({ top: document.body.scrollHeight, behavior: 'smooth' })}
                className="px-8 py-3 border-2 border-white text-white font-medium hover:bg-white hover:text-red-600 transition-all hover:scale-105 active:scale-95"
              >
                VIEW ANALYTICS
              </button>
            </div>
        ...
        {/* Stats Section (UPDATED WITH REAL COUNTS) */}
        <section className="py-16 bg-white border-y border-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-sm tracking-[0.3em] text-red-600 uppercase font-medium mb-2">OVERVIEW</p>
            <div className="w-16 h-px bg-gradient-to-r from-transparent via-red-500 to-transparent mx-auto mb-12" />

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
              {stats.map((stat, index) => (
                <div
                  key={index}
                  className="bg-white rounded-lg p-6 shadow-md hover:shadow-xl transition-all hover:-translate-y-2 border-2 border-gray-100 hover:border-red-600 group cursor-pointer animate-fade-in-up"
                  style={{ animationDelay: `${index * 0.1}s`, opacity: 0 }}
                >
                  <div className="flex items-center justify-between mb-4">
                    <div className="w-12 h-12 bg-red-50 group-hover:bg-red-600 rounded-lg flex items-center justify-center transition-all group-hover:scale-110">
                  ...
                  <p className="text-3xl font-light text-gray-900 mb-2 group-hover:text-red-600 transition-colors">
                    {stat.value}
                  </p>
                  <p className="text-gray-600 text-sm tracking-wide">{stat.label}</p>
                </div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              <p className="text-sm tracking-[0.3em] text-red-600 uppercase font-medium mb-4">MANAGEMENT</p>
              <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4 tracking-tight">Control Center</h2>
              <p className="text-gray-600 max-w-2xl mx-auto">Manage all aspects of your architecture portfolio</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {cards.map((card, index) => (
                <Link
                  key={card.id}
                  to={card.to}
                  className="group bg-white rounded-lg overflow-hidden shadow-md hover:shadow-2xl transition-all hover:-translate-y-2 animate-fade-in-up"
                  style={{ animationDelay: `${index * 0.1}s`, opacity: 0 }}
                >
                  <div className="relative p-8">
                    <div className={`absolute inset-0 bg-gradient-to-br ${card.color} opacity-0 group-hover:opacity-100 transition-opacity`} />
                    <div className="absolute bottom-0 right-0 opacity-5">
                      <card.icon className="w-40 h-40 rotate-12" />
                    </div>

                    <div className="relative z-10">
                      <div className={`w-16 h-16 bg-gradient-to-br ${card.color} rounded-xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all`}>
                        <card.icon className="w-8 h-8 text-white" />
                      </div>

                      <h3 className="text-2xl font-medium text-gray-900 mb-2 group-hover:text-white">
                        {card.title}
                      </h3>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-sm font-medium text-gray-500 group-hover:text-white/80">
                          {card.stats}
                        </span>
                        <div className="flex items-center gap-2 text-red-600 group-hover:text-white font-medium group-hover:gap-3 transition-all">
                          <span>Manage</span>
                          <ArrowRight className="w-4 h-4" />
                        </div>
                      </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg border border-gray-100">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {quickActions.map((action, index) => (
          <div
            ...
            className="group flex flex-col items-center gap-3 p-6 rounded-xl bg-white 
                       hover:bg-gradient-to-br hover:from-red-50 hover:to-white 
                       transition-all duration-300 border-2 border-gray-100 
                       hover:border-red-600 hover:shadow-lg hover:-translate-y-1 cursor-pointer"
          >
            <div className="w-12 h-12 bg-red-50 group-hover:bg-red-600 rounded-lg 
        ...
        {/* Activity + Performance Overview (UNCHANGED UI) */}
        <section className="py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4 p-4 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                      <p className="text-gray-900 font-medium">New project added</p>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                      <p className="text-gray-900 font-medium">Media post published</p>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between mb-2">
                      <span className="text-sm font-medium text-gray-700">Projects Completion</span>
                      <span className="text-sm font-semibold text-red-600">85%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-to-r from-red-600 to-red-700 h-2 rounded-full" style={{ width: "85%" }} />
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between mb-2">
                      ...
                      <span className="text-sm font-semibold text-red-600">78%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-to-r from-red-600 to-red-700 h-2 rounded-full" style={{ width: "78%" }} />
                    </div>
                  </div>
